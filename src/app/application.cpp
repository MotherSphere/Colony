...
void Application::RefreshAddAppDialogEntries()
{
    ...
    const std::size_t totalItems = directories.size() + files.size();
    ...
    {
        addAppDialog_.errorMessage = hasFilter && totalItems > 0 ? "No items match your search." : "Directory is empty.";
    }
